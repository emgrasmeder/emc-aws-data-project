### Code Based on William Liu's Example:
### http://www.williamqliu.com/2013/07/python-data-cleaning.html
### Cloned and edited starting 10/22/2014 by emma grasmeder
...
#with open("filename.extension") as myfile:
...
### Import csv data using third party modules, clean data,
### Not sure if I'm into Liu's output
## Import modules
import numpy
import pandas
import datetime
...
optional_subfolder = '/t-ml-data/'
filename = 
myinputfile = parent +\
    '/datasets/' +\
    optional_subfolder +\
    filename  # Load myinputfile with data
myoutputfile = 'lui-output.csv.csv' # Set File Output Path
### TODO (Rosem3ri) Code from here on hasn't been looked at yet
